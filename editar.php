<?php
    ...
    if (isset($_POST['submit'])){
        ...
        $sql = "update pacientes set paciente_id=$id, paciente_nome='$paciente_nome', sexo='$sexo', endereco='$endereco', numero='$numero', complemento='$complemento', bairro='$bairro',
        cidade='$cidade', cep='$cep', email='$email', celular='$celular', telefone='$telefone', peso='$peso', altura='$altura', hipertensao='$hipertensao', diabetes='$diabetes', 
        fumante='$fumante', cardiaco='$cardiaco', observacoes='$observacoes', medicacao='$medicacao', dt_nasc='$dt_nasc' where paciente_id=$id";
...
<form class="body row" method="post" action="" onsubmit="alerta()">
  ...
  <div class="col-md-2 mb-3">
    ...
    <input type="date" required="" class="form-control" id="dt_nasc" name="dt_nasc" value="<?php echo $dt_nasc;?>">
  </div>
  <div class="col-md-2 mb-3">
    <label for="sexo" class="form-label">Sexo</label>
    <input type="text" required="" class="form-control" list="sexo" id="sexo" name="sexo" value="<?php echo $sexo;?>">
    <datalist id="sexo">
  ...
  <div class="col-md-1 mb-3">
    ...
    <input type="text" required="" class="form-control" id="numero" name="numero" value="<?php echo $numero;?>">
  </div>
  ...
  <div class="col-md-4 mb-3">
    ...
    <input type="text" required="" class="form-control" id="bairro" name="bairro" value="<?php echo $bairro;?>">
  </div>
  <div class="col-md-4 mb-3">
    <label for="cidade" class="form-label">Cidade</label>
    <input type="text" required="" class="form-control" id="cidade" name="cidade" value="<?php echo $cidade;?>">
  </div>
  <div class="col-md-4 mb-3">
    <label for="cep" class="form-label">CEP</label>
    <input type="text" required="" class="form-control" id="cep" name="cep" value="<?php echo $cep;?>">
  </div>
...
?>
  ...
  <div class="col-md-6 mb-3">
    ...
    <input type="text" class="form-control" id="observacoes" name="observacoes" value="<?php echo $observacoes;?>">
  </div>
  <div class="col-md-6 mb-3">
    <label for="medicacao" class="form-label">Medicações em uso</label>
    <input type="text" class="form-control" id="medicacao" name="medicacao" value="<?php echo $medicacao;?>">
  </div>
  <div class="col-md-3 mb-3">
    <button type="submit" name="submit" class="btn btn-primary">Update</button>
    <button type="submit" class="btn btn-secondary"><a href="pacientes.php">Voltar</a></button>
  </div>
</form>
